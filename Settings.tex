...
\newcommand{\myPhase}{Phase A}
\newcommand{\myProject}{Rocksanne 2-Alpha}
\newcommand{\myRevision}{0}
\newcommand{\myIPT}{Launch Facilities\\ Integrated Project Team}
\newcommand{\myTitle}{Normative}
\newcommand{\myAuthor}{Erjola Dushku}
\newcommand{\myEditor}{coloro che lo hanno revisionato}
\newcommand{\myEmail}{erjola.dushku@skywarder.eu}
